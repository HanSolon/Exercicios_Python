...
""" 4 - Escreva um programa que declare um inteir, inicialize-o
...
""" 6 - Faça um programa que leia 10 inteiros e imprima sua meédia.
soma = 0
for i in range(10):
...
valor = int(input("Informe um numero N: "))
impares = []
while valor > 0:
    valor -= 1
    if valor % 2 != 0:
...
números pares 
numero = int(input("Informe um numero > 50: "))
soma = 0
lista = []
if numero > 50:
    while numero > 0:
    ...
    print("Numero < 50") 
print("A soma dos pares: ", sum(lista))
print(lista)"""
